...
const diseasesArray = [
  new diseases({
    type: "diabetes",
    image:
      "https://i.pinimg.com/236x/d5/50/50/d55050ee1a60283c26dabeeff1a1a9b4.jpg",
    question: "General advice for diabetic patients",
    answer: [
      "Eat meals and snacks regularly and at scheduled times",
      "Eat the right amount of food at a meal. Eating more may cause your blood sugar to rise, and eating less may cause it to drop.",
  ...
  new diseases({
    type: "Pressure",
    image:
      "https://i.pinimg.com/236x/7c/cf/e8/7ccfe87970980a7ef618b53f09867bb9.jpg",

    question: "General advice for pressure patients",
    answer: [
      "Use less salt. Processed meats, canned foods, commercial soups, frozen dinners and certain breads can be hidden sources of salt.",
      ...
      "Get more exercise. Regular exercise keeps the body healthy. ",
  ...
  new diseases({
    type: "heart",
    image:
      "https://i.pinimg.com/236x/5d/d9/e0/5dd9e0df72af466217b4d496b913e957.jpg",
  ...
  new diseases({
    type: "kidney ",
    image:
      "https://i.pinimg.com/236x/2e/93/14/2e9314cff7ad953bb77f7a1f6d3860ab.jpg",
  ...
  new diseases({
    type: "liver  ",
    image:
      "https://i.pinimg.com/236x/b0/3b/ae/b03baee592b25b8d79bf33eb6d7151de.jpg",
    ...
    answer: [
      ...
      "Eating fruits and vegetables and lean protein such as legumes, poultry, and fish. Avoid uncooked shellfish.",
